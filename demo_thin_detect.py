...
result_xls_path = "results/result_thin" + timer + "_066_2_1.xls"
...
for file_dict in file_list:
    ...
    if detect_artery:
        ...
        skeleton = tks.Skeleton(img, img_tumor, thin_degree=0.66, max_vessel_tumor_dist=2, max_min_radis_dist=1)
